export default function Footer() {
  return (
    <footer className="footer footer-center bg-base-200 text-base-content p-10 shadow-inner flex flex-col md:flex-row justify-between items-center">
      {/* Main navigation links */}
      <nav className="flex items-center gap-4 sm:gap-6 ">
        <a href="#hero" className="link link-hover">About us</a>
        <a href="#features" className="link link-hover">Features</a>
        <a href="#pricing" className="link link-hover">Pricing</a>
        <a href="#testimonials" className="link link-hover">Contact</a>
      </nav>
      ...
      <nav className="flex  items-center gap-4 sm:gap-6 ">
        ...
        <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors duration-300">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current">
